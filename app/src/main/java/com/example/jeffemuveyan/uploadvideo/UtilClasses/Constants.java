...
public class Constants {
    ...
    public final static String CHANNEL_ID = "com.example.jeffemuveyan.uploadvideo.ANDROID";
    public final static String START_SERVICE = "com.example.jeffemuveyan.uploadvideo.START_SERVICE";
